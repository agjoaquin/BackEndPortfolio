...
public class CProyecto {
    ...
    public ResponseEntity<?> create(@RequestBody DtoProyecto dtoProyecto) {
        ...
        Proyecto proyecto = new Proyecto(dtoProyecto.getTituloP(), dtoProyecto.getDescripcionP(),
                dtoProyecto.getAnioP(),dtoProyecto.getLinkP(),dtoProyecto.getImgP()
        );
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody DtoProyecto dtoProyecto) {
        ...
        proyecto.setAnioP(dtoProyecto.getAnioP());
